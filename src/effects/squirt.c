...
#ifdef GBI_FLOATS
    #define SQUIRT_VTX_GFX_COUNT 72
#else
    #define SQUIRT_VTX_GFX_COUNT 48
#endif
    gSPBranchList(gMainGfxPos, &gMainGfxPos[SQUIRT_VTX_GFX_COUNT + 1]);
    savedGfxPos = gMainGfxPos + 1;

    gMainGfxPos = &gMainGfxPos[SQUIRT_VTX_GFX_COUNT + 1];
