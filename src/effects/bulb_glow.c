...
void bulb_glow_appendGfx(void* effect) {
#ifdef PORT
    // PORT: Original reads framebuffer strips + radial gradient textures for bloom overlay.
    ...
    // additive blending to approximate the circular glow halo.
    {
        ...
        UnkBulbGlow* cfg;
        Color_RGB8* color;
        s32 glowExtent, colorScale, isPointVisible;
        s32 xMin, xMax, yMin, yMax, rectW, rectH;
        u8 r, g, b;
        ...
        xMin = (s32)(centerX - glowExtent);
        xMax = (s32)(centerX + glowExtent);
        yMin = (s32)(centerY - glowExtent);
        yMax = (s32)(centerY + glowExtent);
        ...
        // Color = PRIMITIVE (tinted glow), Alpha = TEXEL0 * PRIMITIVE (gradient mask)
