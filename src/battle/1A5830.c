...
API_CALLABLE(BindTakeTurn) {
    ...
    takeTurnScript = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
...
API_CALLABLE(BindIdle) {
    ...
    idleCode = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
...
API_CALLABLE(BindHandleEvent) {
    ...
    src = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
...
API_CALLABLE(SetDefenseTable) {
    ...
    partID = evt_get_variable(script, *args++);
    table = (u32*)(intptr_t) evt_get_variable(script, *args++);
...
API_CALLABLE(SetIdleAnimations) {
    ...
    partID = evt_get_variable(script, *args++);
    idleAnims = (u32*)(intptr_t) evt_get_variable(script, *args++);
