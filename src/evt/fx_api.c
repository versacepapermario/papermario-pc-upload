...
#ifdef PORT
    if (effect == NULL) {
        fprintf(stderr, "[FX] RemoveEffect: NULL effect pointer!\n");
        return ApiStatus_DONE2;
    }
#endif
...
#ifdef PORT
    if (effect == NULL) {
        fprintf(stderr, "[FX] DismissEffect: NULL effect pointer!\n");
        return ApiStatus_DONE2;
    }
#endif
...
API_CALLABLE(ShowSleepBubble) {
    ...
    evt_set_variable(script, outVar, (intptr_t)effectHandle);
    return ApiStatus_DONE2;
}
...
API_CALLABLE(PlayEffect_impl) {
    ...
    switch (effectID) {
        ...
        case EFFECT_EMOTE:
            ...
            evt_set_variable(script, a8, (intptr_t) sp30);
            break;
        ...
        case EFFECT_GOT_ITEM_OUTLINE:
            ...
            evt_set_variable(script, a6, (intptr_t) sp34);
            break;
        ...
        case EFFECT_SLEEP_BUBBLE:
            ...
            evt_set_variable(script, a7, (intptr_t) sp38);
            break;
        ...
        case EFFECT_3D:
            ...
            evt_set_variable(script, a9, (intptr_t) sp3C);
            break;
        case EFFECT_BLAST:
    ...
    if (effectRet != nullptr) {
        evt_set_variable(script, LVarF, (intptr_t) effectRet);
    }
