        ...
        case 0:
            {
                ...
                NpcGroup* groupList = (NpcGroup*)(intptr_t) evt_get_variable(script, *args++);
                make_npcs(flags, gGameStatusPtr->mapID, (s32*)groupList);
            }
...
API_CALLABLE(BindNpcAI) {
    ...
    Enemy* enemy = script->owner1.enemy;
    s32 id = evt_get_variable(script, *args++);
    EvtScript* newScriptSource = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
    Evt* scriptTemp = script;
...
API_CALLABLE(BindNpcIdle) {
    ...
    EvtScript* aiBytecode = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
...
API_CALLABLE(BindNpcAux) {
    ...
    Enemy* npc = script->owner1.enemy;
    s32 npcID = evt_get_variable(script, *args++);
    EvtScript* auxBytecode = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
...
API_CALLABLE(BindNpcInteract) {
    ...
    Enemy* npc = script->owner1.enemy;
    s32 npcID = evt_get_variable(script, *args++);
    EvtScript* interactBytecode = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
...
API_CALLABLE(BindNpcHit) {
    ...
    Enemy* npc = script->owner1.enemy;
    s32 npcID = evt_get_variable(script, *args++);
    EvtScript* hitBytecode = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
...
API_CALLABLE(BindNpcDefeat) {
    ...
    Enemy* npc = script->owner1.enemy;
    s32 npcID = evt_get_variable(script, *args++);
    EvtScript* defeatBytecode = (EvtScript*)(intptr_t)evt_get_variable(script, *args++);
