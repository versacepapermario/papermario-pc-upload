...
#ifndef PORT
            // On N64, this draws the frozen previous frame over the scene.
            // On PORT, we can't capture the framebuffer, and drawing a dark rect
            // here would cover the star-shaped Z-buffer hole. Skip it.
