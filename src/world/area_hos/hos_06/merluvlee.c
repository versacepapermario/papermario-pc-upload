...
API_CALLABLE(N(func_80241CCC_A3B1AC)) {
    ...
    if (isInitialCall) {
        ...
        script->functionTempPtr[1] = (EffectInstance*)(intptr_t) evt_get_variable(script, ArrayVar(3));
        script->functionTempPtr[2] = (EffectInstance*)(intptr_t) evt_get_variable(script, ArrayVar(4));
        script->functionTempPtr[3] = (EffectInstance*)(intptr_t) evt_get_variable(script, ArrayVar(5));
    }
