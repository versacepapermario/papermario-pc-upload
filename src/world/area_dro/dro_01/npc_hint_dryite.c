...
// Defined in npc.c via MonitorPlayerOrbiting.inc.c (same area, different compilation unit on PC)
extern ApiStatus N(MonitorPlayerOrbiting)(Evt* script, bool isInitialCall);
