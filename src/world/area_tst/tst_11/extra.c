...
API_CALLABLE(N(EnableWallReflectionTest)) {
    port_array_set(script->array, 0, create_worker_frontUI(nullptr, N(test_reflection_worker_render_wall)));
...
API_CALLABLE(N(EnableFloorReflectionTest)) {
    port_array_set(script->array, 0, create_worker_frontUI(nullptr, &N(test_reflection_worker_render_floor)));
    return ApiStatus_DONE2;
}
...
API_CALLABLE(N(PartnerReflectTest)) {
    ...
    port_array_set(script->array, 1, create_worker_scene(N(test_reflection_worker_partner), nullptr));
