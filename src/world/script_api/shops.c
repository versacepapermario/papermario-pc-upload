    ...
    switch (script->functionTemp[0]) {
        case PURCHASE_DIALOG_STATE_INIT:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                D_80286528 = msg_get_printer_for_msg(MSG_Choice_0001, ((bool*)&script->functionTemp[2]));
            }
            break;
    ...
    switch (script->functionTemp[0]) {
        case DIALOG_STATE_AWAIT_GREETING:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTemp[2] = 0;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0003, ((bool*)&script->functionTemp[2]));
            }
            break;
        ...
        case DIALOG_STATE_AWAIT_SELL_CONFIRM:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTemp[2] = 0;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0002, ((bool*)&script->functionTemp[2]));
            }
            break;
        ...
        case DIALOG_STATE_INIT_SELL_MORE_CHOICE:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTemp[2] = 0;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0004, ((bool*)&script->functionTemp[2]));
            }
            break;
        ...
        case DIALOG_STATE_INIT_CHECK_MORE_CHOICE:
            if (!does_script_exist(script->functionTemp[1])) {
                ...
                script->functionTemp[2] = 0;
                ShopOwnerPrintState = msg_get_printer_for_msg(MSG_Choice_0005, ((bool*)&script->functionTemp[2]));
            }
            break;
...
API_CALLABLE(MakeShopOwner) {
    ...
    mapShop->owner = (ShopOwner*)(intptr_t) evt_get_variable(script, *script->ptrReadPos);
    return ApiStatus_DONE2;
}
