...
API_CALLABLE(CreateMapRoom) {
    ...
    openDoorScript  = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
    moveWallsScript = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
    dropDoorScript  = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
    stateListenerScript = (EvtScript*)(intptr_t) evt_get_variable(script, *args++);
    ...
    room->npcList = (s32*)(intptr_t) evt_get_variable(script, *args++);
