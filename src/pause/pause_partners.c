...
#ifdef PORT
// On PORT, image data lives at gPauseBufferPal + 512 (contiguous after palette)
s8* gPausePartnersImageBuffers[] = { gPauseBufferPal1 + 512, gPauseBufferPal2 + 512 };
#else
...
void pause_partners_draw_contents(MenuPanel* menu, s32 baseX, s32 baseY, s32 width, s32 height, s32 opacity, s32 darkening) {
    ...
    draw_box(0, WS_CUSTOM(&gPauseWS_21), baseX + 122, baseY + 16, 0, 166, 121, opacity, darkening, 1.0f, 1.0f, 0, 0, 0, 0, 0, 0, width, height, 0);
}
