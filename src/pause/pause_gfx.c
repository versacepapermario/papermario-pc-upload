...
#ifdef PORT
// On N64, these four BSS arrays are contiguous in overlay BSS: pal1, img1, pal2, img2.
// decode_yay0 in pause_partners_load_portrait writes palette+image data (16264 bytes total)
