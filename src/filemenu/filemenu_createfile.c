...
#if VERSION_PAL
                        filemenu_draw_message((u8*)(uintptr_t)c, baseX + xOffset + ((8 - xNudge) / 2), baseY + yOffset, 255, color, flags);
#else
                        filemenu_draw_message((u8*)(uintptr_t)c, baseX + xOffset, baseY + yOffset, 255, color, flags);
#endif
                    }
                }
            }
