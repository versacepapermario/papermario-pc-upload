...
#ifdef PORT
#define AU_FILE_RELATIVE(base,offset) ((void*)((char*)(base) + (s32)(offset)))
#define AU_PTR_CAST(x) ((intptr_t)(x))
#else
#define AU_FILE_RELATIVE(base,offset) ((void*)((s32)(offset) + (s32)(base)))
#define AU_PTR_CAST(x) ((s32)(x))
#endif
...
#ifdef PORT
// Increase heap for 64-bit: Instrument structs are larger (8-byte pointers),
// and we allocate separate copies via au_convert_bk_instrument_port.
...
#ifdef PORT
// macOS AudioToolbox defines 'MusicPlayer' — rename ours to avoid conflict
typedef enum PM64_MusicPlayer {
    MUSIC_PLAYER_MAIN           = 0,
    MUSIC_PLAYER_AUX            = 1,
} PM64_MusicPlayer;
#define MusicPlayer PM64_MusicPlayer
#else
