// Starpoint digit_1 texture load display list (64x64 IA8)
extern unsigned char D_802A4460_7ABE00[];
Gfx gfx_load_digit_1[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A4460_7ABE00),
