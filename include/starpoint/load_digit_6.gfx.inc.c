// Starpoint digit_6 texture load display list (64x64 IA8)
extern unsigned char D_802A9A00_7B13A0[];
Gfx gfx_load_digit_6[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A9A00_7B13A0),
