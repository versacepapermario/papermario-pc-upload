// Starpoint digit_8 texture load display list (64x64 IA8)
extern unsigned char D_802ABC40_7B35E0[];
Gfx gfx_load_digit_8[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802ABC40_7B35E0),
