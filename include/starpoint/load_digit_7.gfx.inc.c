// Starpoint digit_7 texture load display list (64x64 IA8)
extern unsigned char D_802AAB20_7B24C0[];
Gfx gfx_load_digit_7[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802AAB20_7B24C0),
