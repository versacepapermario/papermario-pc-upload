// Starpoint digit_9 texture load display list (64x64 IA8)
extern unsigned char D_802ACD60_7B4700[];
Gfx gfx_load_digit_9[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802ACD60_7B4700),
