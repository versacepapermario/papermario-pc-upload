// Starpoint digit_4 texture load display list (64x64 IA8)
extern unsigned char D_802A77C0_7AF160[];
Gfx gfx_load_digit_4[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A77C0_7AF160),
