...
// Non-JP: alias ranked partner move names to generic names.
// These must come AFTER message_ids.h which defines the 0x2F section IDs.
#if !VERSION_JP
#undef MSG_PartnerMoveName_BellyFlop1
#undef MSG_PartnerMoveName_BellyFlop2
#undef MSG_PartnerMoveName_BellyFlop3
#undef MSG_PartnerMoveName_BodySlam1
#undef MSG_PartnerMoveName_BodySlam2
#undef MSG_PartnerMoveName_BodySlam3
#undef MSG_PartnerMoveName_ElectroDash1
#undef MSG_PartnerMoveName_ElectroDash2
#undef MSG_PartnerMoveName_ElectroDash3
#undef MSG_PartnerMoveName_Headbonk1
#undef MSG_PartnerMoveName_Headbonk2
#undef MSG_PartnerMoveName_Headbonk3
#undef MSG_PartnerMoveName_ShellToss1
#undef MSG_PartnerMoveName_ShellToss2
#undef MSG_PartnerMoveName_ShellToss3
#undef MSG_PartnerMoveName_SkyDive1
#undef MSG_PartnerMoveName_SkyDive2
#undef MSG_PartnerMoveName_SkyDive3
#undef MSG_PartnerMoveName_Smack1
#undef MSG_PartnerMoveName_Smack2
#undef MSG_PartnerMoveName_Smack3
#undef MSG_PartnerMoveName_SpinyFlip1
#undef MSG_PartnerMoveName_SpinyFlip2
#undef MSG_PartnerMoveName_SpinyFlip3
...
// PORT: On 64-bit, intptr_t is 8 bytes which breaks struct layout.
// These JP string literals are unused in the US build — replace with 0.
#ifdef PORT
#define JP_STR_MSG(s) 0
#else
#define JP_STR_MSG(s) (s32)(s)
#endif
