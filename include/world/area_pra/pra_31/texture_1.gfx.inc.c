...
Gfx N(texture_1_gfx)[] = {
    ...
    {(uintptr_t)0xFD500000, (uintptr_t)N(texture_1_img)},  // gsDPSetTextureImage -> N(texture_1_img)
    ...
    {(uintptr_t)0xFD100000, (uintptr_t)N(texture_1_pal)},  // gsDPSetTextureImage -> N(texture_1_pal)
