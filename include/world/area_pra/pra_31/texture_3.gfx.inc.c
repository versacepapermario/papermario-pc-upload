...
Gfx N(texture_3_gfx)[] = {
    ...
    {(uintptr_t)0xFD100000, (uintptr_t)N(texture_3_img)},  // gsDPSetTextureImage -> N(texture_3_img)
    {(uintptr_t)0xF5100000, (uintptr_t)0x07054150},  // gsDPSetTile
    {(uintptr_t)0xE6000000, (uintptr_t)0x00000000},  // gsDPLoadSync
    {(uintptr_t)0xF3000000, (uintptr_t)0x073FF100},  // gsDPLoadBlock
    {(uintptr_t)0xE7000000, (uintptr_t)0x00000000},  // gsDPPipeSync
    {(uintptr_t)0xF5101000, (uintptr_t)0x00054150},  // gsDPSetTile
