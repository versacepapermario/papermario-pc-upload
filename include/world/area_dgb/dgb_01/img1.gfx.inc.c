...
Gfx N(img1_gfx)[] = {
    ...
    {(uintptr_t)0xFD100000, (uintptr_t)dgb_01_img1_png},  // gsDPSetTextureImage -> dgb_01_img1_png
    {(uintptr_t)0xF5100000, (uintptr_t)0x07054160},  // gsDPSetTile
    {(uintptr_t)0xE6000000, (uintptr_t)0x00000000},  // gsDPLoadSync
    {(uintptr_t)0xF3000000, (uintptr_t)0x077FF080},  // gsDPLoadBlock
    {(uintptr_t)0xE7000000, (uintptr_t)0x00000000},  // gsDPPipeSync
    {(uintptr_t)0xF5102000, (uintptr_t)0x00054160},  // gsDPSetTile
    {(uintptr_t)0xF2000000, (uintptr_t)0x000FC07C},  // gsDPSetTileSize
