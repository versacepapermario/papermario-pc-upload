...
Gfx N(img4_gfx)[] = {
    ...
    {(uintptr_t)0xFD100000, (uintptr_t)dgb_01_img4_png},  // gsDPSetTextureImage -> dgb_01_img4_png
    {(uintptr_t)0xF5100000, (uintptr_t)0x07054140},  // gsDPSetTile
    {(uintptr_t)0xE6000000, (uintptr_t)0x00000000},  // gsDPLoadSync
    {(uintptr_t)0xF3000000, (uintptr_t)0x071FF200},  // gsDPLoadBlock
    {(uintptr_t)0xE7000000, (uintptr_t)0x00000000},  // gsDPPipeSync
    {(uintptr_t)0xF5100800, (uintptr_t)0x00054140},  // gsDPSetTile
