...
#ifdef PORT
extern intptr_t CreateEntityVarArgBuffer[];
#else
...
#ifdef PORT
// On PC, entity model data is compiled into the executable as PC-format arrays.
// Use the symbol directly — no need to offset into DMA'd N64 ROM data.
#define ENTITY_ADDR(entity, type, data) ((type)(data))
#else
#define ENTITY_ADDR(entity, type, data) (type)((intptr_t)(entity->gfxBaseAddr) + ((intptr_t)(data) & 0xFFFF))
#endif
