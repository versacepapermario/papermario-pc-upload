// Level_up big_P texture load display list (64x64 IA8)
extern unsigned char D_802A2490_7A03D0[];
Gfx D_802A3490_7A13D0[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A2490_7A03D0),
