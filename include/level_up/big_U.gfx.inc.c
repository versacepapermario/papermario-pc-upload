// Level_up big_U texture load display list (64x64 IA8)
extern unsigned char D_802A4580_7A24C0[];
Gfx D_802A5580_7A34C0[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A4580_7A24C0),
