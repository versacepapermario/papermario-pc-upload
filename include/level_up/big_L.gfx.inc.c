// Level_up big_L texture load display list (64x64 IA8)
extern unsigned char D_802A55F8_7A3538[];
Gfx D_802A65F8_7A4538[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b, 1, D_802A55F8_7A3538),
